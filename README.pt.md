...
**Habilidade LLM** — instale o plugin [Buildev Skill](https://github.com/bryfar/Buildev-skill) para ensinar agentes IA (Claude Code, Cursor, Codex, Gemini CLI, etc.) a projetar com `op`.
