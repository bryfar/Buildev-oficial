...
const ko: TranslationKeys = {
  ...
  'topbar.modes': '모드',
  'topbar.modesTooltip': '편집 모드: 디자인 캔버스, IDE 또는 HTML 미리보기',
  'topbar.modesDesign': '디자인',
  'topbar.modesIde': 'IDE',
  'topbar.modesPreview': '미리보기',
  'topbar.exitIde': 'IDE 종료',
  'topbar.ideStatusLabel': 'Buildev — 준비됨',
  ...
  'topbar.ideActivityExplorer': '탐색기',
  'topbar.ideActivityCode': '코드 생성',
  'topbar.ideActivityBarAria': 'IDE 활동 표시줄',
  'topbar.idePanelDesign': '디자인',
  'topbar.idePanelTabProblems': '문제',
  'topbar.idePanelTabOutput': '출력',
  'topbar.idePanelTabTerminal': '터미널',
  'topbar.idePanelTabPorts': '포트',
  'topbar.idePanelTabDesign': '디자인',
  'topbar.ideBottomPanelAria': '하단 패널',
  'topbar.ideExplorerSection': '탐색기',
  'topbar.ideOutlineLayers': '개요',
  'topbar.idePanelPlaceholderProblemsTitle': '문제',
  'topbar.idePanelPlaceholderProblemsBody': '작업 영역에서 문제가 감지되지 않았습니다.',
  'topbar.idePanelPlaceholderOutputTitle': '출력',
  'topbar.idePanelPlaceholderOutputBody': '확장 프로그램의 프로세스 출력이 여기에 표시됩니다.',
  'topbar.idePanelPlaceholderTerminalTitle': '터미널',
  'topbar.idePanelPlaceholderTerminalBody':
    '통합 터미널은 아직 연결되지 않았습니다. Buildev과 함께 시스템 셸을 사용하세요.',
  'topbar.idePanelPlaceholderPortsTitle': '포트',
  'topbar.idePanelPlaceholderPortsBody': '전달된 포트와 로컬 URL은 사용할 수 있게 되면 여기에 표시됩니다.',
  'topbar.ideEditorChunkError': '편집기 모듈을 로드하지 못했습니다',
  'topbar.ideMonacoLoading': '코드 편집기를 시작하는 중…',
  'topbar.ideMonacoErrorTitle': '코드 편집기를 로드하지 못했습니다',
  'topbar.ideEditorLoading': '편집기 로드 중…',
  'topbar.ideEditorDocument': '문서 버퍼',
  'topbar.ideEditorTabsAria': '열려 있는 편집기',
  ...
  'topbar.ideVirtualFilesSection': '열린 파일',
  'topbar.ideVirtualFilesAria': 'IDE용 가상 프로젝트 파일',
  'topbar.ideNewVirtualFile': '새 파일',
  'topbar.ideNewVirtualFilePrompt': '가상 경로(기본값은 프레임 파일과 같은 폴더)',
  'topbar.ideNewVirtualFileAria': '이 프레임 아래 새 가상 파일 만들기',
  'topbar.ideMigrationPreviewTitle': '스택 변경 미리보기',
  'topbar.ideMigrationPreviewAria': '현재 및 선택한 스택의 JSON 미리보기',
  ...
  'share.title': '공유',
  'share.editorLink': '편집기 링크',
  'share.editorLinkHint':
    '이 페이지 URL을 복사합니다. 캔버스는 로컬 .op 파일 또는 Git에 있습니다. 동일한 디자인을 열려면 해당 파일이나 저장소를 보내세요.',
  'share.openHtmlPreview': '새 탭에서 HTML 미리보기 열기',
  'share.mcpEndpoint': 'MCP 엔드포인트(AI 도구)',
  'share.mcpHint':
    'Buildev이 실행 중일 때 Claude, Cursor 등 MCP 클라이언트를 이 URL로 지정하면 캔버스를 읽고 편집할 수 있습니다.',
  'share.mcpLanHint': 'LAN: http://{{ip}}:{{port}}/mcp',
  'share.documentPath': '디스크의 문서',
  'share.documentPathHint': '이 컴퓨터에 저장된 파일의 전체 경로입니다.',
  'share.gitRemote': 'Git 원격(origin)',
  'share.gitRemoteHint': '이 URL을 공유하면 다른 사람이 저장소를 클론하거나 포크할 수 있습니다.',
  'share.noGitRemote': '이 Git 저장소에 아직 origin 원격이 구성되어 있지 않습니다.',
  'share.noGitRemoteNoFile': '문서를 저장하고 Git을 설정하면 원격 URL이 표시됩니다.',
  'share.copy': '복사',
  'share.copied': '복사됨',
  ...
  'git.conflict.nonOp.description':
    '.op 파일 병합은 완료되었지만 저장소의 다른 파일이 아직 해결되지 않았습니다. Buildev 외부에서 해결한 후 계속하세요.',
  ...
  'rightPanel.design.motion.section': '모션 및 코드',
  ...
  'animation.title': '애니메이션',
  'animation.entry': '애니메이션',
  ...
  'agents.mcpReinstallHint':
    'Buildev 버전 업그레이드 후 호환성을 위해 MCP 통합을 다시 설치해 주세요.',
  ...
  'figma.autoLayout': 'Buildev 자동 레이아웃',
  ...
  // ── Project Flow ──
    ...
    'projectFlow.shell.createWorkspace': '새 작업 공간',
    'projectFlow.shell.noProjectOpen': '열린 프로젝트 없음',
