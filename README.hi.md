...
<p align="center">
  <strong>ओपन-सोर्स AI-नेटिव डिज़ाइन-टू-कोड प्लेटफ़ॉर्म।</strong><br />
  <sub>विज़ुअल कैनवस + IDE मोड · डिज़ाइन-एज़-कोड · मल्टी-फ्रेमवर्क एक्सपोर्ट · कंकरेंट AI एजेंट</sub>
</p>
...
<p align="center">
  <a href="https://oss.ioa.tech/zseven/buildev/a46e24733239ce24de36702342201033.mp4">
    <img src="./screenshot/op-cover.png" alt="Buildev — डेमो देखने के लिए क्लिक करें" width="100%" />
  </a>
</p>
...
> **नोट:** इसी नाम का एक और ओपन-सोर्स प्रोजेक्ट है — [Buildev](https://github.com/open-pencil/open-pencil), जो रियल-टाइम सहयोग के साथ Figma-संगत विज़ुअल डिज़ाइन पर केंद्रित है। यह प्रोजेक्ट AI-नेटिव डिज़ाइन-टू-कोड वर्कफ़्लो पर केंद्रित है।
...
| इमेज                         | आकार    | शामिल                |
| ---------------------------- | ------- | -------------------- |
| `buildev:latest`          | ~226 MB | केवल वेब ऐप          |
...
| `buildev-full:latest`     | ~1 GB   | सभी CLI टूल          |
...
**LLM स्किल** — [Buildev Skill](https://github.com/bryfar/Buildev-oficial-skill) प्लगइन इंस्टॉल करें ताकि AI एजेंट (Claude Code, Cursor, Codex, Gemini CLI आदि) `op` से डिज़ाइन करना सीख सकें।
...
Buildev मुफ़्त और ओपन-सोर्स है। इसका विकास उन लोगों के सहयोग से चलता है जिन्हें यह उपयोगी लगता है — कैनवस को खुला रखने के लिए धन्यवाद।

<a href="https://github.com/mrqyun" title="MrQyun">
  <img src="https://wsrv.nl/?url=github.com/mrqyun.png&w=128&h=128&mask=circle&maxage=7d" width="64" height="64" alt="MrQyun" />
</a>

**[MrQyun](https://github.com/mrqyun)** को धन्यवाद — अपना नाम यहाँ देखना चाहते हैं? **[प्रायोजक बनें →](https://github.com/sponsors/bryfar)**
