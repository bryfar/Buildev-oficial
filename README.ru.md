...
<p align="center">
  <strong>Платформа с открытым исходным кодом для дизайн-кода на базе ИИ.</strong><br />
  <sub>Визуальный холст + IDE режим · Дизайн-как-код · Мультифреймворк экспорт · Параллельные ИИ-агенты</sub>
</p>
...
> **Примечание:** Существует другой проект с открытым исходным кодом с таким же названием — [Buildev](https://github.com/open-pencil/open-pencil), ориентированный на визуальный дизайн, совместимый с Figma, с совместной работой в реальном времени. Этот проект ориентирован на AI-нативные рабочие процессы «дизайн в код».
...
| ---------------------------- | ------- | --------------------- |
| `buildev:latest`          | ~226 МБ | Только веб-приложение |
...
| `buildev-full:latest`     | ~1 ГБ   | Все CLI-инструменты   |
...
**LLM-навык** — установите плагин [Buildev Skill](https://github.com/bryfar/Buildev-oficial-skill), чтобы научить ИИ-агентов (Claude Code, Cursor, Codex, Gemini CLI и др.) проектировать с помощью `op`.
...
Buildev бесплатен и open source. Разработка финансируется теми, кому он полезен — спасибо, что держите холст открытым.

<a href="https://github.com/mrqyun" title="MrQyun">
  <img src="https://wsrv.nl/?url=github.com/mrqyun.png&w=128&h=128&mask=circle&maxage=7d" width="64" height="64" alt="MrQyun" />
</a>

Спасибо **[MrQyun](https://github.com/mrqyun)** — хотите видеть здесь своё имя? **[Стать спонсором →](https://github.com/sponsors/bryfar)**
