...
**LLM Becerisi** — [Buildev Skill](https://github.com/bryfar/Buildev-skill) eklentisini kurarak AI ajanlarına (Claude Code, Cursor, Codex, Gemini CLI vb.) `op` ile tasarım yapmayı öğretin.
