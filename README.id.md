...
**LLM Skill** — instal plugin [Buildev Skill](https://github.com/bryfar/Buildev-skill) untuk mengajarkan agen AI (Claude Code, Cursor, Codex, Gemini CLI, dll.) mendesain dengan `op`.
