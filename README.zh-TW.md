...
<p align="center">
  <a href="https://oss.ioa.tech/zseven/buildev/a46e24733239ce24de36702342201033.mp4">
    <img src="./screenshot/op-cover.png" alt="Buildev — 點擊觀看示範影片" width="100%" />
  </a>
</p>
...
> **注意：** 另有一個同名的開源專案 — [Buildev](https://github.com/open-pencil/open-pencil)，專注於相容 Figma 的視覺設計與即時協作。本專案專注於 AI 原生的設計轉程式碼工作流。
...
| 映像檔                       | 大小    | 包含                 |
| ---------------------------- | ------- | -------------------- |
| `buildev:latest`          | ~226 MB | 僅 Web 應用程式      |
...
| `buildev-full:latest`     | ~1 GB   | 所有 CLI 工具        |
...
**LLM 技能** — 安裝 [Buildev Skill](https://github.com/bryfar/Buildev-oficial-skill) 外掛，教 AI 智慧體（Claude Code、Cursor、Codex、Gemini CLI 等）使用 `op` 進行設計。
...
Buildev 免費且開源,開發完全由覺得它好用的人們贊助 —— 感謝你讓這塊畫布一直保持開放。

<a href="https://github.com/mrqyun" title="MrQyun">
  <img src="https://wsrv.nl/?url=github.com/mrqyun.png&w=128&h=128&mask=circle&maxage=7d" width="64" height="64" alt="MrQyun" />
</a>

感謝 **[MrQyun](https://github.com/mrqyun)** —— 想把自己的名字也放在這裡?**[成為贊助者 →](https://github.com/sponsors/bryfar)**
