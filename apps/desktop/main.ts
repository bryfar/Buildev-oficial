...
// macOS: ~/Library/Application Support/Buildev/
// Windows: %APPDATA%\Buildev\
// Linux: ~/.config/Buildev/
...
// ---------------------------------------------------------------------------
// Port file for MCP sync discovery (~/.buildev/.port)
// ---------------------------------------------------------------------------
