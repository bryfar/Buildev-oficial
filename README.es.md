...
**Habilidad LLM** — instala el plugin [Buildev Skill](https://github.com/bryfar/Buildev-skill) para enseñar a agentes IA (Claude Code, Cursor, Codex, Gemini CLI, etc.) a diseñar con `op`.
