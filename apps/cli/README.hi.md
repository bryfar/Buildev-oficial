...
[Buildev](https://github.com/bryfar/Buildev-oficial) के लिए CLI — अपने टर्मिनल से डिज़ाइन टूल को नियंत्रित करें।
...
CLI सभी प्लेटफ़ॉर्म पर Buildev डेस्कटॉप ऐप को स्वचालित रूप से पहचानता और लॉन्च करता है:
...
```bash
op start [--desktop|--web]   # Buildev लॉन्च करें (डिफ़ॉल्ट रूप से डेस्कटॉप)
