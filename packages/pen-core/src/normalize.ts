/**
 * Normalize a Pencil.dev .pen document into Buildev's internal format.
 *
...
import type { PenFill, PenStroke, GradientStop } from '@buildev/pen-types';
