...
const vi: TranslationKeys = {
  ...
  'topbar.modes': 'Chế độ',
  'topbar.modesTooltip': 'Chế độ trình soạn thảo: canvas Design, IDE hoặc xem trước HTML',
  'topbar.modesDesign': 'Thiết kế',
  'topbar.modesIde': 'IDE',
  'topbar.modesPreview': 'Xem trước',
  'topbar.exitIde': 'Thoát IDE',
  'topbar.ideStatusLabel': 'Buildev — Sẵn sàng',
  ...
  'topbar.ideActivityExplorer': 'Trình khám phá',
  'topbar.ideActivityCode': 'Sinh mã',
  'topbar.ideActivityBarAria': 'Thanh hoạt động IDE',
  'topbar.idePanelDesign': 'Thiết kế',
  'topbar.idePanelTabProblems': 'Sự cố',
  'topbar.idePanelTabOutput': 'Đầu ra',
  'topbar.idePanelTabTerminal': 'Terminal',
  'topbar.idePanelTabPorts': 'Cổng',
  'topbar.idePanelTabDesign': 'Thiết kế',
  'topbar.ideBottomPanelAria': 'Bảng dưới',
  'topbar.ideExplorerSection': 'Trình khám phá',
  'topbar.ideOutlineLayers': 'Dàn bài',
  'topbar.idePanelPlaceholderProblemsTitle': 'Sự cố',
  'topbar.idePanelPlaceholderProblemsBody': 'Không phát hiện sự cố trong không gian làm việc.',
  'topbar.idePanelPlaceholderOutputTitle': 'Đầu ra',
  'topbar.idePanelPlaceholderOutputBody': 'Đầu ra tiến trình từ tiện ích mở rộng sẽ hiển thị tại đây.',
  'topbar.idePanelPlaceholderTerminalTitle': 'Terminal',
  'topbar.idePanelPlaceholderTerminalBody':
    'Terminal tích hợp chưa được kết nối. Hãy dùng shell hệ thống cùng với Buildev.',
  'topbar.idePanelPlaceholderPortsTitle': 'Cổng',
  'topbar.idePanelPlaceholderPortsBody':
    'Cổng chuyển tiếp và URL cục bộ sẽ hiển thị tại đây khi có.',
  'topbar.ideEditorChunkError': 'Không tải được mô-đun trình soạn thảo',
  'topbar.ideMonacoLoading': 'Đang khởi động trình soạn thảo mã…',
  'topbar.ideMonacoErrorTitle': 'Không tải được trình soạn thảo mã',
  'topbar.ideEditorLoading': 'Đang tải trình soạn thảo…',
  'topbar.ideEditorDocument': 'Bộ đệm tài liệu',
  'topbar.ideEditorTabsAria': 'Trình soạn thảo đang mở',
  ...
  'topbar.ideVirtualFilesSection': 'Tệp đang mở',
  'topbar.ideVirtualFilesAria': 'Tệp dự án ảo cho IDE',
  'topbar.ideNewVirtualFile': 'Tệp mới',
  'topbar.ideNewVirtualFilePrompt': 'Đường dẫn ảo (mặc định cùng thư mục với tệp frame)',
  'topbar.ideNewVirtualFileAria': 'Tạo tệp ảo mới trong frame này',
  'topbar.ideMigrationPreviewTitle': 'Xem trước đổi stack',
  'topbar.ideMigrationPreviewAria': 'Xem trước JSON của stack hiện tại và stack đã chọn',
  ...
  'share.title': 'Chia sẻ',
  'share.editorLink': 'Liên kết trình chỉnh sửa',
  'share.editorLinkHint':
    'Sao chép URL trang này. Canvas nằm trong tệp .op cục bộ hoặc Git — hãy gửi tệp hoặc kho lưu trữ để người khác mở cùng thiết kế.',
  'share.openHtmlPreview': 'Mở xem trước HTML trong tab mới',
  'share.mcpEndpoint': 'Điểm cuối MCP (công cụ AI)',
  'share.mcpHint':
    'Khi Buildev đang chạy, hãy trỏ Claude, Cursor hoặc các MCP client khác tới URL này để đọc và chỉnh sửa canvas.',
  'share.mcpLanHint': 'Trên mạng LAN: http://{{ip}}:{{port}}/mcp',
  'share.documentPath': 'Tài liệu trên đĩa',
  'share.documentPathHint': 'Đường dẫn đầy đủ tới tệp đã lưu trên máy tính này.',
  'share.gitRemote': 'Remote Git (origin)',
  'share.gitRemoteHint': 'Chia sẻ URL này để người khác clone hoặc fork kho lưu trữ.',
  'share.noGitRemote': 'Chưa cấu hình remote origin cho kho Git này.',
  'share.noGitRemoteNoFile': 'Hãy lưu tài liệu và thiết lập Git để xem URL remote.',
  'share.copy': 'Sao chép',
  ...
  'git.conflict.nonOp.description':
    'Gộp .op đã hoàn tất, nhưng các tệp khác trong kho vẫn chưa được giải quyết. Giải quyết chúng bên ngoài Buildev, sau đó tiếp tục.',
  ...
  'rightPanel.design.motion.section': 'Chuyển động và mã',
  ...
  'animation.title': 'Hoạt ảnh',
  'animation.entry': 'Hoạt ảnh',
  ...
  'agents.mcpReinstallHint':
    'Sau khi nâng cấp Buildev, vui lòng cài đặt lại tích hợp MCP để đảm bảo tương thích.',
  ...
  'figma.autoLayout': 'Bố cục tự động Buildev',
  ...
  // ── Project Flow ──
    ...
    'projectFlow.shell.createWorkspace': 'Không gian làm việc mới',
    'projectFlow.shell.noProjectOpen': 'Chưa có dự án nào được mở',
