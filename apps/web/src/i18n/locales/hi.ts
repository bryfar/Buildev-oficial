...
const hi: TranslationKeys = {
  ...
  'topbar.preview': 'पूर्वावलोकन',
  'topbar.share': 'साझा करें',
  ...
  'topbar.modes': 'मोड',
  'topbar.modesTooltip': 'संपादक मोड: डिज़ाइन कैनवास, IDE या HTML पूर्वावलोकन',
  'topbar.modesDesign': 'डिज़ाइन',
  'topbar.modesIde': 'IDE',
  'topbar.modesPreview': 'पूर्वावलोकन',
  'topbar.exitIde': 'IDE बंद करें',
  'topbar.ideStatusLabel': 'Buildev — तैयार',
  ...
  'topbar.ideActivityExplorer': 'एक्सप्लोरर',
  'topbar.ideActivityCode': 'कोड जनरेशन',
  'topbar.ideActivityBarAria': 'IDE गतिविधि पट्टी',
  'topbar.idePanelDesign': 'डिज़ाइन',
  'topbar.idePanelTabProblems': 'समस्याएँ',
  'topbar.idePanelTabOutput': 'आउटपुट',
  'topbar.idePanelTabTerminal': 'टर्मिनल',
  'topbar.idePanelTabPorts': 'पोर्ट',
  'topbar.idePanelTabDesign': 'डिज़ाइन',
  'topbar.ideBottomPanelAria': 'निचला पैनल',
  'topbar.ideExplorerSection': 'एक्सप्लोरर',
  'topbar.ideOutlineLayers': 'रूपरेखा',
  'topbar.idePanelPlaceholderProblemsTitle': 'समस्याएँ',
  'topbar.idePanelPlaceholderProblemsBody': 'वर्कस्पेस में कोई समस्या नहीं मिली।',
  'topbar.idePanelPlaceholderOutputTitle': 'आउटपुट',
  'topbar.idePanelPlaceholderOutputBody': 'एक्सटेंशन प्रक्रियाओं का आउटपुट यहाँ दिखेगा।',
  'topbar.idePanelPlaceholderTerminalTitle': 'टर्मिनल',
  'topbar.idePanelPlaceholderTerminalBody':
    'एकीकृत टर्मिनल अभी जुड़ा नहीं है। Buildev के साथ सिस्टम शेल का उपयोग करें।',
  'topbar.idePanelPlaceholderPortsTitle': 'पोर्ट',
  'topbar.idePanelPlaceholderPortsBody':
    'फ़ॉरवर्ड किए गए पोर्ट और स्थानीय URL उपलब्ध होने पर यहाँ दिखेंगे।',
  'topbar.ideEditorChunkError': 'संपादक मॉड्यूल लोड नहीं हो सका',
  'topbar.ideMonacoLoading': 'कोड संपादक शुरू हो रहा है…',
  'topbar.ideMonacoErrorTitle': 'कोड संपादक लोड नहीं हो सका',
  'topbar.ideEditorLoading': 'संपादक लोड हो रहा है…',
  'topbar.ideEditorDocument': 'दस्तावेज़ बफ़र',
  'topbar.ideEditorTabsAria': 'खुले संपादक',
  ...
  'git.conflict.nonOp.description':
    '.op विलय पूरा हो गया है, लेकिन रेपो की अन्य फ़ाइलें अभी भी अनसुलझी हैं। उन्हें Buildev के बाहर हल करें, फिर जारी रखें।',
  ...
  'rightPanel.design.motion.section': 'मोशन और कोड',
  ...
  'agents.mcpReinstallHint':
    'Buildev अपग्रेड करने के बाद, संगतता सुनिश्चित करने के लिए कृपया MCP इंटीग्रेशन पुनः इंस्टॉल करें।',
  ...
  'figma.autoLayout': 'Buildev ऑटो लेआउट',
  ...
  // ── Project Flow ──
    ...
    'projectFlow.shell.createWorkspace': 'नया वर्कस्पेस',
    'projectFlow.shell.noProjectOpen': 'कोई प्रोजेक्ट खुला नहीं है',
