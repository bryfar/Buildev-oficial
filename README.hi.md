...
**LLM स्किल** — [Buildev Skill](https://github.com/bryfar/Buildev-skill) प्लगइन इंस्टॉल करें ताकि AI एजेंट (Claude Code, Cursor, Codex, Gemini CLI आदि) `op` से डिज़ाइन करना सीख सकें।
