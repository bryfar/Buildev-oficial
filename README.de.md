...
**LLM-Skill** — Installieren Sie das [Buildev Skill](https://github.com/bryfar/Buildev-skill)-Plugin, um KI-Agenten (Claude Code, Cursor, Codex, Gemini CLI usw.) das Designen mit `op` beizubringen.
