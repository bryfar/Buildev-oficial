...
CLI для [Buildev](https://github.com/bryfar/Buildev-oficial) — управляйте инструментом дизайна из терминала.
...
CLI автоматически обнаруживает и запускает настольное приложение Buildev на всех платформах:
...
```bash
op start [--desktop|--web]   # Запустить Buildev (по умолчанию — настольное приложение)
