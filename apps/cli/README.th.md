...
CLI สำหรับ [Buildev](https://github.com/bryfar/Buildev-oficial) — ควบคุมเครื่องมือออกแบบจากเทอร์มินัลของคุณ
...
CLI จะตรวจจับและเปิดแอปเดสก์ท็อป Buildev โดยอัตโนมัติบนทุกแพลตฟอร์ม:
...
```bash
op start [--desktop|--web]   # เปิด Buildev (เดสก์ท็อปเป็นค่าเริ่มต้น)
